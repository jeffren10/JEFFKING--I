...
const Contact = () => {
  ...
  return (
    <div name='contact' className='w-full md:h-screen overflow-hidden bg-[#0a192f] flex justify-center items-center p-4 '>
      <form onSubmit={onFinish} className='flex flex-col max-w-[600px] w-full'> 
        <div className='pb-3'> 
          <p className='text-4xl font-bold inline border-b-4 border-pink-600 text-gray-300 '>Contact </p>
          <p className='text-gray-300 py-4'>// submit the form below or shoot me an email -ijeffren1@gmail.com </p>
        </div>
        ...
        <button type='submit' className='text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-4 py-2 my-3 mx-auto flex items-center'  >Let's collaborate</button>
      </form>
    </div>
  )
}
